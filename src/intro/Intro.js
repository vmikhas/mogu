		...
		<div className="intro__container container">
			<div className="intro__tracker">
				...
				<ul className="intro__list">
					{tags.map((tag, id) => <li className={`intro__item intro__item_${id}`} key={'item-'+id}>{tag}</li>)}
				</ul>
			...
			<div className="intro__wrapper">
				...
				<ul className="intro__user-list">
					{icons.map((icon, id) => <li className={`intro__user-item intro__user-item_${id}`} key={'item-'+id}><a
						className="intro__user-link" href="#1"><img className="intro__user-icon" src={icon} alt=""/></a>
					</li>)}
				</ul>
